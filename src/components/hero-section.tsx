...
const PILLARS: ProductPillar[] = ["Nocturnal", "Phototactic", "Unprofitable"];
 ...
 *
 * The plate is the page's light source, so the moth on it is rendered dark
 * (`text-accent-ink`) rather than gold — a silhouette against the lamp, which
 * is the entire idea behind the name. Gold on gold would simply vanish.
 */
      ...
      <div className="hero-grid relative mx-auto grid min-h-[calc(100svh-92px)] max-w-7xl items-center gap-10 px-4 py-10 sm:px-6 lg:px-8">
        <div className="hero-copy max-w-3xl">
          <p className="mb-6 flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.24em] text-accent">
            <MothMark className="icon-glow size-4" />
            A memecoin about a moth
          </p>
          ...
          >
            {/* Both lines are measured to fit the 659px column at the 84px lg
                size, so neither breaks and orphans a word. */}
            Drawn to light,
            <span className="block text-accent">same as you.</span>
          </h1>

          <p className="mt-7 max-w-2xl text-base leading-7 text-mute-1 sm:text-lg sm:leading-8">
            $MOTH is a memecoin. There is no protocol behind it, no yield, and
            no roadmap — just a token, a moth, and whatever the market decides
            that is worth.
          </p>
        ...
        <div className="hero-visual relative min-h-[520px]" aria-hidden="true">
          <div className="hero-frame absolute inset-0 overflow-hidden rounded-3xl border border-edge bg-ink-deep">
            <div className="flex items-center justify-between border-b border-edge px-6 py-5 text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-mute-3">
              <span>Attracted to light since 2026</span>
              <span className="text-accent">$MOTH</span>
            </div>
